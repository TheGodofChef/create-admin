...
export const useTheme = () => {
  ...
  const { primary, isDark, isGrey, isWeak, asideInverted, headerInverted, layout } = storeToRefs(golbalStore)
  ...
  const changePrimary = (val: string | null) => {
    ...
    golbalStore.setGlobalState('primary', val)
  }
  ...
  const changeGreyOrWeak = (type: Theme.GreyOrWeakType, value: boolean) => {
    ...
    golbalStore.setGlobalState(propName, false)
  }
